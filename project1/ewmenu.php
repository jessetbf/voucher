...
$RootMenu->AddMenuItem(1, $Language->MenuPhrase("1", "MenuText"), "caregiverslist.php?cmd=resetall", -1, "", TRUE, FALSE);
$RootMenu->AddMenuItem(2, $Language->MenuPhrase("2", "MenuText"), "colonieslist.php", -1, "", TRUE, FALSE);
$RootMenu->AddMenuItem(3, $Language->MenuPhrase("3", "MenuText"), "voucherslist.php?cmd=resetall", -1, "", TRUE, FALSE);
$RootMenu->Render();
?>
</div>
<!-- End Main Menu -->
